...
export declare type DBCluster = import("./dbcluster").DBCluster;
...
export declare type DBClusterParameterGroup = import("./dbclusterParameterGroup").DBClusterParameterGroup;
...
export declare type DBInstance = import("./dbinstance").DBInstance;
export declare const DBInstance: typeof import("./dbinstance").DBInstance;
export { DBSubnetGroupArgs } from "./dbsubnetGroup";
export declare type DBSubnetGroup = import("./dbsubnetGroup").DBSubnetGroup;
