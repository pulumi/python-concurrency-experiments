 ...
 */
export declare class PolicyPrincipalAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyPrincipalAttachment;
    /**
     ...
     */
    static isInstance(obj: any): obj is PolicyPrincipalAttachment;
