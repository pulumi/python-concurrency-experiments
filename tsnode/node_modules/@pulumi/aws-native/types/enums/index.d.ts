...
export { amplify, apigateway, appflow, applicationinsights, apprunner, athena, auditmanager, batch, billingconductor, budgets, cassandra, ce, cloudformation, cloudfront, cloudtrail, codeguruprofiler, codegurureviewer, codestarnotifications, connect, cur, customerprofiles, databrew, datasync, devicefarm, devopsguru, ec2, ecr, ecs, eks, elasticache, emr, events, evidently, finspace, fms, forecast, frauddetector, fsx, gamelift, globalaccelerator, glue, greengrassv2, groundstation, healthlake, imagebuilder, inspectorv2, iot, iotanalytics, iotevents, iotfleetwise, iotsitewise, iottwinmaker, iotwireless, ivs, kafkaconnect, kendra, kinesis, kinesisanalyticsv2, kinesisfirehose, kinesisvideo, kms, lakeformation, lambda, lex, lightsail, location, logs, lookoutequipment, lookoutmetrics, m2, macie, mediaconnect, mediapackage, mediatailor, memorydb, msk, mwaa, networkfirewall, nimblestudio, panorama, personalize, pinpoint, quicksight, rds, redshift, redshiftserverless, refactorspaces, resiliencehub, resourcegroups, robomaker, rolesanywhere, route53, route53recoverycontrol, route53resolver, rum, s3, s3outposts, sagemaker, servicecatalog, servicecatalogappregistry, signer, ssm, ssmcontacts, ssmincidents, sso, stepfunctions, supportapp, timestream, transfer, wafv2, wisdom, workspaces, };
