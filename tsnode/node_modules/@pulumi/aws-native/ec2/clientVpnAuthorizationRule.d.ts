 ...
 */
export declare class ClientVpnAuthorizationRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientVpnAuthorizationRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is ClientVpnAuthorizationRule;
