 ...
 */
export declare class DBSecurityGroupIngress extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBSecurityGroupIngress;
    /**
     * Returns true if the given object is an instance of DBSecurityGroupIngress.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DBSecurityGroupIngress;
    readonly cIDRIP: pulumi.Output<string | undefined>;
    readonly dBSecurityGroupName: pulumi.Output<string>;
    readonly eC2SecurityGroupId: pulumi.Output<string | undefined>;
    readonly eC2SecurityGroupName: pulumi.Output<string | undefined>;
    readonly eC2SecurityGroupOwnerId: pulumi.Output<string | undefined>;
    /**
