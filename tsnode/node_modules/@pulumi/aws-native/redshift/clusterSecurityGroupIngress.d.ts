 ...
 */
export declare class ClusterSecurityGroupIngress extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSecurityGroupIngress;
    /**
     ...
     */
    static isInstance(obj: any): obj is ClusterSecurityGroupIngress;
    readonly cIDRIP: pulumi.Output<string | undefined>;
    readonly clusterSecurityGroupName: pulumi.Output<string>;
